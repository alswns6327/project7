...
<!-- 헤더 -->
<div class="header">
	<a href="homePage"><h2>홈페이지 이름</h2></a>
</div>
...
<body width="100%" height="100%" onload="job('${job}')" style="background-image: url('images/loginback.jpg')">
      	...
      	<div class="flex-container">
		    ...
		    <div class="a">
		      <div class="idForm1">
		        ...
		        <span  id="password2" style="color: white;"></span>
		  	</div>  
		  </div>
		    ...
		    <div class="flex-box">
		      <div class="a">
		      <div class="idForm1">
		        <input type="text" name="phone" class="id" placeholder="phone" autocomplete="off">
		      </div>
		      </div>
    ...
    <div id="pwFind">
      ...
      <br/>
      <div class="idForm2">
        <input type="text" name="phone" id="pwFind_phoneNum" class="id" placeholder="'-'없이 휴대폰 번호를 입력하세요." autocomplete="off"><input type="button" value="문자발송" onclick="pw_message()"/>
      </div>
      <div class="idForm2">
        <input type="text" name="num2" class="id" placeholder="인증번호를 입력하세요." autocomplete="off"><input type="button" value="확인" onclick="numCheck2()"/>
        <span id="true" style=""></span>
      </div>
