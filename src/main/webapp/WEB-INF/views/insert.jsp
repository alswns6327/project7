	...
	<div class="container">
		<form action="insertOK">
			<div class="writeWrap" style="width: 1000px; height: 580px;" align="center">
				...
				<br/>
				<div class="btnFlex">
					<button type="submit" class="btn btn-default" align="center">등록하기</button>&nbsp;&nbsp;
					<button type="button" class="btn btn-default" align="center" onclick="history.back()">뒤로가기</button>
				</div>
				<c:if test="${id!=null}">
