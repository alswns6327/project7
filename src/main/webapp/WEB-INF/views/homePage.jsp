            ...
            <div class="container my-5">
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-6" style="color: white;">
                        ...
                        <p class="lead" style="font-weight: bold;">고가의 스피커, 조명, 가구를 우리집에서 매달 저렴한 가격으로 즐겨보세요.</p><br><br>
                        <form class="d-flex">
                    		<c:if test="${id!=null&&id.trim().length()!=0}">
                        		<button type="button" class="btn btn-outline-success flex-shrink-0" style="border: none;" id="button" onclick="pay('350000','Basic','${id}')">
                        			구독하기
                        		</button>
                    		</c:if>
                        	<c:if test="${id==null||id.trim().length()==0}">
                        		<button type="button" class="btn btn-outline-success flex-shrink-0" style="border: none;" onclick="alert('로그인 후 사용가능합니다.')">
                        			구독하기
                        		</button>
                        	</c:if>
                        </form>
            ...
            <div class="container my-5">
                <div class="row">
                    <div class="col-lg-6" style="color: white;">
                        ...
                        <p class="lead" style="font-weight: bold;">럭셔리, 고급 가구를 우리집에서 만나다. 우수한 브랜드의 존재 이유를 알 수 있습니다.</p><br><br>
                        <form class="d-flex">
                    		<c:if test="${id!=null&&id.trim().length()!=0}">
                        		<button type="button" class="btn btn-outline-danger flex-shrink-0" style="border: none;" onclick="pay('450000','Standard','${id}')">
                        		구독하기
                        		</button>
                    		</c:if>
                        	<c:if test="${id==null||id.trim().length()==0}">
            ...
            <div class="container my-5">
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-6" style="color: white;">
                        ...
                        <p class="lead" style="font-weight: bold;">지금까지 경험해보지 못한 다양한 High-end 제품들을 매달 저렴한 가격으로 무제한으로 즐기세요. 추가 요금이 전혀 없습니다.</p><br><br>
                        <form class="d-flex">
                    		<c:if test="${id!=null&&id.trim().length()!=0}">
                        		<button type="button" class="btn btn-outline-light flex-shrink-0" style="border: none;" onclick="pay('550000','Premium','${id}')">
                        		구독하기
                        		</button>
                    		</c:if>
                        	<c:if test="${id==null||id.trim().length()==0}">
                        		<button type="button" class="btn btn-outline-light flex-shrink-0" style="border: none;" onclick="alert('로그인 후 사용가능합니다.')">
                        		구독하기
                        		</button>
                        	</c:if>
                        </form>
