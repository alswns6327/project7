                ...
                <div class="row gx-4 gx-lg-5 align-items-center">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="d-flex">
                        	<!-- 제품 개수 입력칸 -->
                        	<c:if test="${id!=null&&id.trim().length()!=0}">
	                        	<button class="btn btn-outline-danger flex-shrink-0" type="submit" style="max-width: 10rem;" onclick="wish('3','William Divano con Chaise Longue - Tocco 32003 Perla', '${id}','interior/interiorDetail00')"><i class="bi bi-heart"></i> 
		                        	관심등록하기
		                        </button>&nbsp;&nbsp;&nbsp;
		                        <button class="btn btn-outline-dark flex-shrink-0" type="submit" style="max-width: 10rem" onclick="choice('3','William Divano con Chaise Longue - Tocco 32003 Perla', '${id}','interior/interiorDetail00')">
		                        &nbsp;구독하기&nbsp;
		                        </button>
		                	</c:if>
		                	<c:if test="${id==null||id.trim().length()==0}">
