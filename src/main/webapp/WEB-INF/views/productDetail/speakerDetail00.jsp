            ...
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="d-flex">
	                        <c:if test="${id!=null&&id.trim().length()!=0}">
	                        	<button class="btn btn-outline-danger flex-shrink-0" type="submit" style="max-width: 10rem;" onclick="wish('1','A9 4세대 블루투스스피커_Smoked Oak', '${id}','speaker/speakerDetail00')"><i class="bi bi-heart"></i> 
		                        	관심등록하기
		                        </button>&nbsp;&nbsp;&nbsp;
		                        <button class="btn btn-outline-dark flex-shrink-0" type="submit" style="max-width: 10rem" onclick="choice('1','A9 4세대 블루투스스피커_Smoked Oak', '${id}','speaker/speakerDetail00')">
		                        &nbsp;구독하기&nbsp;
		                        </button>
		                	</c:if>
		                	<c:if test="${id==null||id.trim().length()==0}">
