                    ...
                    <div class="col-md-6">
                        ...
                        <div class="d-flex">
                            <c:if test="${id!=null&&id.trim().length()!=0}">
		                        ...
		                        <button class="btn btn-outline-dark flex-shrink-0" type="submit" style="max-width: 10rem" onclick="choice('1','A9 4세대 블루투스스피커_Smoked Oak', '${id}','speaker/speakerDetail01')">
		                        &nbsp;구독하기&nbsp;
		                        </button>
		                	</c:if>
		                	<c:if test="${id==null||id.trim().length()==0}">
